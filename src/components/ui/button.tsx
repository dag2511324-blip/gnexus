  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "relative overflow-hidden bg-gold text-background font-bold tracking-wide before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-cream/20 before:to-transparent before:-translate-x-full hover:before:translate-x-full before:transition-transform before:duration-700 shadow-[0_0_40px_hsl(38,70%,50%,0.4)] hover:shadow-[0_0_60px_hsl(38,70%,50%,0.6)]",
        heroOutline: "border-2 border-gold/60 bg-transparent text-gold font-bold tracking-wide hover:bg-gold/10 hover:border-gold transition-all duration-300",
      },
      size: {
