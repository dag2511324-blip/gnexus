/**
 * Minimax AI-Style Sidebar
 */

import { Plus, Search, Image, History, Menu } from 'lucide-react';
        ...
        <div className="w-64 h-full bg-[#1a1a1a] border-r border-white/10 flex flex-col">
            ...
            <div className="p-6 border-b border-white/10">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xl font-bold text-white">G-NEXUS</span>
                </div>
            </div>
            ...
            <div className="flex-1 p-4 space-y-2">
                ...
                <div className="pt-4 border-t border-white/10 mt-4">
                    <div className="text-xs text-gray-500 px-3 py-2">Task History</div>
                    <Button
                        variant="ghost"
                        className="w-full justify-start gap-3 text-gray-400 hover:text-white hover:bg-white/10"
                    >
            ...
            <div className="p-4 border-t border-white/10">
                <div className="text-xs text-gray-500">About G-NEXUS</div>
